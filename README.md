...
###### 21.07.2025  
1. Ветка jenkins только для запуска на Jenkins.  

###### 23.07.2025  
1. Ветка main для прогона GitHub Actions. С передаваемым параметром в gradle.yml:  
>-Dselenide.remote=http://localhost:4444/wd/hub
2. Добавлена отправка уведомлений о прохождении теста в Telegram